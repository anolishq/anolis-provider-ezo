...
const anolis::deviceprovider::v1::DeviceHealth *find_device_health(
    const anolis::deviceprovider::v1::GetHealthResponse &response, const std::string &device_id) {
...
TEST(HandlersTest, WaitReadyAndGetHealthReflectActiveAndExcludedDevices) {
    ...
    anolis_provider_ezo::handlers::handle_wait_ready(anolis::deviceprovider::v1::WaitReadyRequest{}, wait_response);
    ...
    anolis_provider_ezo::handlers::handle_get_health(anolis::deviceprovider::v1::GetHealthRequest{}, health_response);
